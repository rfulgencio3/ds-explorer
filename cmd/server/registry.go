...
var registry = []Structure{
	...
	{ID: "trie", Name: "Trie", EnglishName: "Trie", Category: "Árvore", DotNetName: "custom Trie", Implementation: "árvore de prefixos", Description: "Árvore especializada para armazenar chaves por prefixos compartilhados.", UseCases: "Muito útil para autocomplete, dicionários e busca por prefixo.", Tradeoffs: "Pode consumir bastante memória quando o alfabeto ou as chaves crescem.", ReferenceURL: "https://www.nist.gov/dads/HTML/trie.html", ReferenceSource: "NIST DADS", SearchBig0: "O(m)", InsertBig0: "O(m)", UpdateBig0: "O(m)", Available: false, UsageFrequency: "Pouco comum"},
}
